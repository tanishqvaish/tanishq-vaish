...
const sampleListingsWithGeo = sampleListings.map((obj) => ({
  ...obj,
  geometry: {
    type: "Point",
    coordinates: locationCoords[obj.location] || [77.2090, 28.6139]
  }
}));

module.exports = { data: sampleListingsWithGeo };